            ...
            {(enrichment.monitoring?.length ?? 0) > 0 ? (
              <>
                ...
                {enrichment.action_threshold ? (
                  <View style={[styles.warning, { marginTop: 10, backgroundColor: Colors.coral + '14' }]}>
...
const styles = StyleSheet.create({
  ...
  productMetaValue: { fontSize: FontSize.subheadline, fontWeight: '600', color: Colors.text, marginTop: 2 },
  // --- References ---
