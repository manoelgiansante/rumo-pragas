export default {
  ...
  settings: {
    ...
    deleteConfirmMessage:
      'Esta acción es INMEDIATA e irreversible. Se eliminarán:\n\n• Sus fotos subidas\n• Su historial de diagnósticos\n• Su perfil y configuraciones\n• Su suscripción en nuestro sistema\n\nAdvertencia: el cobro de la suscripción en App Store / Google Play NO se cancela automáticamente. Cancélela antes en Ajustes > Apple ID > Suscripciones (o Play Store > Suscripciones).\n\n¿Desea continuar?',
    ...
    deletionReceivedMessage:
      'Su cuenta y todos los datos asociados han sido eliminados. Si tiene una suscripción activa, recuerde cancelarla en Ajustes > Apple ID > Suscripciones (iOS) o Play Store > Suscripciones (Android).',
