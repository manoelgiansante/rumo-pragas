export default {
  ...
  diagnosis: {
    ...
    proLockedAlt: 'Función Pro — actualice para ver alternativas',
    proLockedShare: 'PDF es una función Pro',
    proLockedHistory: 'Historial ilimitado es Pro',
    proLockedDetails: 'Ficha técnica completa es Pro',
    proCtaUpgrade: 'Obtener Pro',
    proCtaSee: 'Ver planes',
