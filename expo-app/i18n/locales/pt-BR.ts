export default {
  ...
  settings: {
    ...
    deleteConfirmMessage:
      'Esta ação é IMEDIATA e irreversível. Serão apagados:\n\n• Suas fotos enviadas\n• Seu histórico de diagnósticos\n• Seu perfil e configurações\n• Sua assinatura no nosso sistema\n\nAtenção: a cobrança da assinatura na App Store / Google Play NÃO é cancelada automaticamente. Cancele antes em Ajustes > Apple ID > Assinaturas (ou Play Store > Assinaturas).\n\nDeseja continuar?',
    ...
    deletionReceivedMessage:
      'Sua conta e todos os dados associados foram excluídos. Se você tem uma assinatura ativa, lembre-se de cancelá-la em Ajustes > Apple ID > Assinaturas (iOS) ou Play Store > Assinaturas (Android).',
