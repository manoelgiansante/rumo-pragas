import { Pest, SeverityLevel } from '../types';

export const allPests: Pest[] = [
  // ==================== SOJA ====================
  {
    id: 'soja-lagarta',
...
export function pestsForCrop(crop: string): Pest[] {
  return allPests.filter(p => p.crop === crop);
}

export function searchPests(query: string): Pest[] {
  if (!query) return allPests;
...
export function pestById(id: string): Pest | undefined {
  return allPests.find(p => p.id === id);
}
